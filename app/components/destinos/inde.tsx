      ...
      <div className="carousel-inner" style={{ display: "flex" }}>
        ...
        >
          <div className="polaroid shadow-xl border border-gray-300 rounded-md p-4 m-2 w-80 h-full ">
            ...
            <p className="text-sm text-gray-600 px-4 m-2">
              Punta Cana é dos destinos mais procurados pelos viajantes de todo
              o mundo! É a tua vez de conheceres este paraíso! Dança ao ritmo da
              Bachata, mergulha nas praias incríveis de areia branca, ruma até
              Isla Saona e diverte-te no CocoBongo!
            </p>
          </div>
        </div>
        <div
        ...
        >
          <div className="polaroid shadow-xl border border-gray-300 rounded-md p-4 m-2 w-80 h-full">
            ...
            />
            <p className="text-sm text-gray-600 px-4 m-2">
              A cidade maravilhosa faz jus ao apelido! Festas, praias, cultura,
              gastronomia e clima tropical! Diverte-te no Rio de Janeiro ao
              ritmo do Samba!
            </p>
          </div>
        </div>
        ...
        >
          <div className="polaroid shadow-xl border border-gray-300 rounded-md p-4 m-2 w-80 h-full">
            ...
            <p className="text-sm text-gray-600 px-4 m-2">
              ...
              esculturais esculpidas pela natureza, onde os balões de ar quente
              dançam pelos céus pintados de tons dourados. Deixe-se encantar
              pela história, cultura e paisagens únicas desta terra dos contos
              de fadas.
            </p>
          </div>
        </div>
        ...
        >
          <div className="polaroid shadow-xl border border-gray-300 rounded-md p-4 m-2 w-80 h-full">
            ...
            />
            <p className="text-sm text-gray-600 px-4 m-2">
              Mergulha na agitação e luzes brilhantes de Times Square, assiste a
              um espetáculo da Broadway. Aproveita para conhecer a Grand Central
              Terminal e perde-te no Central Park, um dos destaques da cidade!
              Estás preparado para a cidade que nunca dorme?
            </p>
          </div>
        </div>
      </div>
